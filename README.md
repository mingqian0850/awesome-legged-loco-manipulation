...
| Year | Title | Authors / Organization | Venue | Robot | Resources |
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **FRAMES: Failure Recovery And Monitoring of Embodied Skills for Humanoid Loco-Manipulation** | Ajay Vikram Periasami et al. | arXiv | Unitree G1 | [Paper](https://arxiv.org/abs/2609.22538) |
