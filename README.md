...
| Year | Title | Authors / Organization | Venue | Robot | Resources |
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **DreamMimic: Learning Visuomotor Whole-Body Loco-Manipulation via World Model** | Jie Yin, Xingyu Lai | IROS | Humanoid (OMOMO / Unitree G1) | [Paper](https://arxiv.org/abs/2608.22278) |
