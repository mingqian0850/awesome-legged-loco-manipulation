...
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **Calf-Integrated Arms for Bimanual Quadruped Loco-Manipulation** | Yan Pan et al. | arXiv | Unitree Go2 + Dual Calf-Integrated Arms | [Paper](https://arxiv.org/abs/2607.06186) |
