...
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **BinWalker: Development and Field Evaluation of a Quadruped Manipulator Platform for Sustainable Litter Collection** | Giulio Turrisi et al. | AIM | Unitree Aliengo + Z1 Arm | [Paper](https://arxiv.org/abs/2603.10529) · [Code](https://github.com/iit-DLSLab/trash-collection-isaaclab) |
