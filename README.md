...
| Year | Title | Authors / Organization | Venue | Robot | Resources |
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **FetchMan: Learning Visual Humanoid Loco-Manipulation Policies from Simulated Experiences** | Omar Rayyan et al. | arXiv | Unitree G1 | [Paper](https://arxiv.org/abs/2608.17027) · [Project](https://orayyan.com/fetchman) · [Code](https://github.com/omarrayyann/FetchMan) |
