...
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **Sumo: Dynamic and Generalizable Whole-Body Loco-Manipulation** | John Z. Zhang et al. | arXiv | Boston Dynamics Spot + Arm | [Paper](https://arxiv.org/abs/2604.08508) · [Project](https://sumo.rai-inst.com/) · [Code](https://github.com/rai-opensource/sumo) · [Video](https://youtu.be/eKUSpB9G7Rk) |
