...
| :--: | --- | --- | :---: | --- | --- |
| 2026 | **DeViGrasp: Robust Visual Mobile Grasping for Quadruped Manipulators under Degraded Perception** | Liang Zhou et al. | arXiv | Unitree B1 + Z1 Arm | [Paper](https://arxiv.org/abs/2609.22278) |
